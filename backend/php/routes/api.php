...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/skus', [SkuController::class, 'store'])->middleware('rbac:' . RoleType::EDITOR->value . ',' . RoleType::ADMIN->value);
    Route::put('/skus/{id}', [SkuController::class, 'update'])->middleware('rbac:' . RoleType::EDITOR->value . ',' . RoleType::ADMIN->value);
    ...
    Route::post('/clusters', [ClusterController::class, 'store'])->middleware('rbac:' . RoleType::GOVERNOR->value . ',' . RoleType::ADMIN->value);
    Route::put('/clusters/{id}', [ClusterController::class, 'update'])->middleware('rbac:' . RoleType::GOVERNOR->value . ',' . RoleType::ADMIN->value);
    ...
    Route::post('/briefs', [BriefController::class, 'store'])->middleware('rbac:EDITOR,ADMIN');
});
